...
async def play(_, message: Message):
           ...
           for administrator in administrators:
                      if administrator == message.from_user.id:  
                          ...
                          try:
                              ...
                              await USER.send_message(message.chat.id,"gaana gaane k liye join kra h group in VC")
                              await lel.edit(
                              ...
                              await lel.edit(
                                  ...
                                  "\n\nOr manually add @queen_rinky to your Group and try again</b>",
                              )
                              pass
    try:
    ...
    try:
        ...
        await lel.edit("gaana nii mila koi dusra bja ya dhang se likh")
        print(str(e))
        return
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        try:
            ...
            await message.reply(f"Group Call is not connected or I can't join it\n\nReason {e}")
            return
        await message.reply_photo(
        photo="final.png",
        reply_markup=keyboard,
